...
//=========Question 1==================================
	...
	void TestQ1_empty_strings(CuTest *tc) {
...
//=================Question 2================================
	...
	void TestQ2_studentProgramTest (CuTest *tc) {

	    char gradesTest[] = "gradesTest.txt";
	    char studentsTest[] = "studentsTest.txt";
	    char outputTest[] = "outputTest.txt";
	    char outputGolden[] = "outputGoldenTest.txt";
	    int size;
	    int i;

	    int expectedNumStudents = studentProgram(gradesTest, studentsTest, outputTest);
	    FILE *testfile = fopen(outputTest, "r");
	    FILE *goldenfile = fopen(outputGolden, "r");
	    int actualID, expectedID;
	    double actualFinalGrade, expectedFinalGrade;
...
//===========================================================
	CuSuite* Lab3GetSuite() {
		...
		SUITE_ADD_TEST(suite, TestQ1_empty_strings);
		...
		SUITE_ADD_TEST(suite, TestQ2_studentProgramTest);
